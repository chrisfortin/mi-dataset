...
f.write('' + '\n')
f.write('' + '\n')
f.write('def parse(basePythonCodePath, sourceFilePath, particleDataHdlrObj):' + '\n')
f.write('    """' + '\n')
f.write('    This is the method called by Uframe' + '\n')
f.write('    :param basePythonCodePath This is the file system location of mi-dataset' + '\n')
f.write('    :param sourceFilePath This is the full path and filename of the file to be parsed' + '\n')
f.write('    :param particleDataHdlrObj Java Object to consume the output of the parser' + '\n')
f.write('    :return particleDataHdlrObj' + '\n')
f.write('    """' + '\n')
f.write('' + '\n')
f.write('    with open(sourceFilePath, \'rb\') as stream_handle:' + '\n')
f.write('' + '\n')
f.write('        # create an instance of the concrete driver class defined below' + '\n')
f.write('        driver = ' + camel_case_driver_name + '(basePythonCodePath, stream_handle, particleDataHdlrObj)' + '\n')
